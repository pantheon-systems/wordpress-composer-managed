...
* Fixes an issue where WP REST API urls would break on new sites before "pretty permalink" structure was set. ([#181](https://github.com/pantheon-systems/wordpress-composer-managed/pull/181))
