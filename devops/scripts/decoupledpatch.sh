...
$SED -i'' 's#PTARGET3.*#"pantheon-systems/pantheon-decoupled-auth-example": "dev-main",#g' composer.json
$SED -i'' 's#PTARGET2.*#"pantheon-systems/pantheon-decoupled": "dev-main",#g' composer.json
$SED -i'' 's#PTARGET1.*#"wpackagist-plugin/wp-gatsby": "^2.0",#g' composer.json

# Repeat above steps for repositories
$SED -i'' -n 'p;s/"repositories":/PTARGET4&/p' composer.json
$SED -i'' -n 'p;s/PTARGET4/PTARGET5&/p' composer.json
